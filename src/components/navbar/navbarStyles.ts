...
export const NAV_OUTER_SURFACE_IDLE_CLASS = "border-transparent bg-[var(--nav-bg-idle)]";
...
export const NAV_MOBILE_OUTER_RADIUS_CLASS = "[border-radius:var(--nav-outer-r)]";

export const NAV_MOBILE_DROPDOWN_INNER_RADIUS_CLASS = "[border-radius:var(--nav-inner-r)]";

export const NAV_MOBILE_DROPDOWN_CONTACT_RADIUS_CLASS = "[border-radius:var(--nav-contact-r)]";
...
export function navOuterSurfaceClass(isScrolled: boolean) {
  return isScrolled ? NAV_OUTER_SURFACE_SCROLLED_CLASS : NAV_OUTER_SURFACE_IDLE_CLASS;
}
